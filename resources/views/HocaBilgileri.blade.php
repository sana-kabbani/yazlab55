                                        ...
                                        <form action="">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleFormControlSelect1">Hoca</label>
                                                        <select class="form-control" id="exampleFormControlSelect1">
                                                            <option>Serdar Solak</option>
                                                            <option>Hikmet Hakan</option>
                                                            <option>Yavuz Selim</option>
                                ...
                                <div class="card card-social .card-body ">
                                    ...
                                    <div class="card-block border-bottom">
                                        ...
                                        <div class="row align-items-center justify-content-center">
                                            ...
                                            <div class="col ">
                                                <h6 class="mb-3">Adı: <span class="text-muted ml-1">Serdar</span></h6>
                                                <h6 class="mb-3">Soyadı: <span class="text-muted ml-1">Solak</span></h6>
                                                <h6 class="mb-3">Unvanı: <span class="text-muted ml-1">profesor</span>
                                                </h6>

                                            </div>
                                            <div class="col">

                                                <h6 class="mb-3">Numara: <span class="text-muted ml-1">12564684</span>
                                                </h6>
                                                <h6 class="mb-3">E-Posta: <span
                                                        class="text-muted ml-1">test123@gmail.com</span></h6>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar progress-c-theme" role="progressbar"
                                                        style="width:100%;height:6px;" aria-valuenow="100"
